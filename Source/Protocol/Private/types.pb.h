...
enum protocol : int {
  ...
  kLightContentNotify = 4102,
  kHeavyContentNotify = 4103,
  kMapTestReq = 4106,
  kCreateCharacterReq = 4107,
  kCreateCharacterRes = 4108,
  kGetCharacterListReq = 4109,
  kGetCharacterListRes = 4110,
  kChangeCharacterNameReq = 4111,
  kChangeCharacterNameRes = 4112,
  kLoginReq = 4113,
  kLoginRes = 4114,
  kKeyValueStorage_Put = 4115,
  kKeyValueStorage_Delete = 4116,
  kCreateItemNotify = 4117,
...
constexpr protocol protocol_MAX = static_cast<protocol>(4117);
constexpr int protocol_ARRAYSIZE = 4117 + 1;
